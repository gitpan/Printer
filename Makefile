# This Makefile is for the Printer extension to perl.
#
...
#	ABSTRACT => q[low-level, platform independent printing (curently Linux and      MS Win32. other UNIXES should also work.)]
#	AUTHOR => q[Stephen Patterson <steve@lexx.uklinux.net>]
#	NAME => q[Printer]
#	PREREQ_PM => {  }
#	VERSION_FROM => q[Printer.pm]
...
TO_INST_PM = Printer.pm

PM_TO_BLIB = Printer.pm \
...
manifypods : pure_all Printer.pm
	@$(POD2MAN) \
	Printer.pm \
	$(INST_MAN3DIR)/Printer.$(MAN3EXT)
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Printer\" VERSION=\"0,96,0,0\">\n}. qq{\t<TITLE>Printer</TITLE>\n}. qq{\t<ABSTRACT>low-level, platform independent printing (curently Linux and \n    MS Win32. other UNIXES should also work.)</ABSTRACT>\n}. qq{\t<AUTHOR>Stephen Patterson &lt;steve\@lexx.uklinux.net&gt;</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Printer.ppd
